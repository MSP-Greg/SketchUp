...
def CTCode.tool_1()
  tool = Object.new
  def tool.onLButtonDown(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'Down') ; end
  def tool.onMButtonDown(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'Down') ; end
  def tool.onRButtonDown(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'Down') ; end

  def tool.onLButtonUp(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'Up') ; end
  def tool.onMButtonUp(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'Up') ; end
  def tool.onRButtonUp(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'Up') ; end

  def tool.onLButtonDoubleClick(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'DblClk') ; end
  def tool.onMButtonDoubleClick(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'DblClk') ; end
  def tool.onRButtonDoubleClick(flags, x, y, view) ; CTCode.mouse(flags, x, y, view, 'DblClk') ; end
